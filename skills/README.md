...
- **requirements-analyst** - 需求分析和规格定义
- **design-consultant** - 设计咨询和方案创建
- **frontend-builder** - 前端开发实施
- **project-workflow** - 完整项目管理工作流
...
- **core-work-rules** - 核心工作规则(触发词、验证要求、代码质量标准)
- **work-rules** - 基础工作原则和指导
