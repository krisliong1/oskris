...
Provides various easing functions for natural motion and timing in Oskris GIF animations.
All functions take a value t (0.0 to 1.0) and return eased value (0.0 to 1.0).

Common use cases in web design:
- Loading spinners: ease_in_out for smooth rotation
- Scroll animations: ease_out for natural deceleration
- Bounce effects: bounce_out for playful interactions
- Hero text: elastic_out for attention-grabbing entrance
"""
